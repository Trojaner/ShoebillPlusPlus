...
public class DialogCloseEvent extends DialogEvent<net.gtaun.shoebill.event.dialog.DialogCloseEvent> implements Cancellable {
    private boolean cancelled;
    private DialogCloseType type;

    public DialogCloseEvent(net.gtaun.shoebill.event.dialog.DialogCloseEvent base) {
        super(base);
        type = base.getType();
    }
