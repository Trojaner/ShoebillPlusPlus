...
public abstract class CheckpointEvent<T extends net.gtaun.shoebill.event.checkpoint.CheckpointEvent> extends ShoebillEvent<T> {
    private Player player;
    private Checkpoint checkpoint;

    protected CheckpointEvent(T base) {
        super(base);
