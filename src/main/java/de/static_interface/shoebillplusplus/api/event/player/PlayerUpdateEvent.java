...
public class PlayerUpdateEvent extends PlayerEvent<net.gtaun.shoebill.event.player.PlayerUpdateEvent>
                               implements Cancellable, Allowable {
    private boolean cancelled;
    private boolean allowed;

    public PlayerUpdateEvent(net.gtaun.shoebill.event.player.PlayerUpdateEvent base) {
        super(base);
        allowed = true;
    }
