...
public class PlayerTextEvent extends PlayerEvent<net.gtaun.shoebill.event.player.PlayerTextEvent>
                             implements Cancellable, Allowable {
    private boolean cancelled;
    private boolean allowed;
    private String text;

    public PlayerTextEvent(net.gtaun.shoebill.event.player.PlayerTextEvent base) {
        super(base);
        text = getBase().getText();
        allowed = true;
    }
