...
import de.static_interface.shoebillplusplus.api.plugin.RegisteredListener;
...
public class HandlerList {
     ...
     */
    public static void unregisterAll(Resource resource) {
        synchronized (allLists) {
            for (HandlerList h : allLists) {
                h.unregister(resource);
            }
        }
    }
     ...
     */
    public synchronized void unregister(Resource resource) {
     ...
     */
    public static ArrayList<RegisteredListener> getRegisteredListeners(Resource resource) {
                ...
                synchronized (h) {
                    for (List<RegisteredListener> list : h.handlerslots.values()) {
                        for (RegisteredListener listener : list) {
                            if (listener.getResource().equals(resource)) {
