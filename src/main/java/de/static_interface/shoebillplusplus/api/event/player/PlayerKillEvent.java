...
public class PlayerKillEvent extends PlayerEvent<net.gtaun.shoebill.event.player.PlayerKillEvent> implements Cancellable {
    private boolean cancelled;
    private Player victim;
    private WeaponModel reason;

    public PlayerKillEvent(net.gtaun.shoebill.event.player.PlayerKillEvent base) {
        super(base);
