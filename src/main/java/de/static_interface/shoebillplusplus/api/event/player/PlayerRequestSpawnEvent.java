...
public class PlayerRequestSpawnEvent extends PlayerEvent<net.gtaun.shoebill.event.player.PlayerRequestSpawnEvent>
                                     implements Cancellable, Allowable {
    private boolean cancelled;
    private boolean allowed;

    public PlayerRequestSpawnEvent(net.gtaun.shoebill.event.player.PlayerRequestSpawnEvent base) {
        super(base);
        allowed = true;
    }
